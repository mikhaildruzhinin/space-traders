 ...
 * @param registration The public registration information of the ship
 ...
 * @param strength Mounts that have this value, such as mining lasers, denote how powerful this mount's capabilities are.
